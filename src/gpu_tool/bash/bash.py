    ...
    def _get_cpu_info(self):
        ...
        if isinstance(self.dmidecode['type_4'],list):
            for cpu in self.dmidecode['type_4']:
                tmp = cpu['fields']
                a = f"CPU{self.i18n.get('socket')}:{tmp.get('Socket Designation')}   SN:{tmp.get('Serial Number')}  U:{tmp.get('Upgrade')}\nCPU{self.i18n.get('ver')}:{tmp.get('Version')}\n  CPU{self.i18n.get('core_count')}:{tmp.get('Core Count')}  CPU{self.i18n.get('thread_count')}:{tmp.get('Thread Count')}  {tmp.get('Signature').split(',')[-1].strip()}\n{self.i18n.get('cpu_max_clock')}:{tmp.get('Max Speed')}   {self.i18n.get('cpu_current_clock')}:{tmp.get('Current Speed')} \n  {self.i18n.get('L1_cache')}:{self.find_type_by_handle(tmp.get('L1 Cache Handle'))['fields']['Maximum Size']}  {self.i18n.get('L2_cache')}:{self.find_type_by_handle(tmp.get('L2 Cache Handle'))['fields']['Maximum Size']}  {self.i18n.get('L3_cache')}:{self.find_type_by_handle(tmp.get('L3 Cache Handle'))['fields']['Maximum Size']}"

                sysdate.cpuinfo.append(a)
        else:
            tmp = self.dmidecode['type_4']['fields']
            sysdate.cpuinfo.append(f"CPU{self.i18n.get('socket')}:{tmp.get('Socket Designation')}   SN:{tmp.get('Serial Number')}  U:{tmp.get('Upgrade')}\nCPU{self.i18n.get('ver')}:{tmp.get('Version')}\n  CPU{self.i18n.get('core_count')}:{tmp.get('Core Count')}  CPU{self.i18n.get('thread_count')}:{tmp.get('Thread Count')}  {tmp.get('Signature').split(',')[-1].strip()}\n{self.i18n.get('cpu_max_clock')}:{tmp.get('Max Speed')}   {self.i18n.get('cpu_current_clock')}:{tmp.get('Current Speed')} \n  {self.i18n.get('L1_cache')}:{self.find_type_by_handle(tmp.get('L1 Cache Handle'))['fields']['Maximum Size']}  {self.i18n.get('L2_cache')}:{self.find_type_by_handle(tmp.get('L2 Cache Handle'))['fields']['Maximum Size']}  {self.i18n.get('L3_cache')}:{self.find_type_by_handle(tmp.get('L3 Cache Handle'))['fields']['Maximum Size']}")
